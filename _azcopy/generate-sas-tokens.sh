...
EXEMPLOS:
    ...
    $0 -s stbanprdbrstest -t fileshare -n client1

    # Gerar SAS para Blob Container (read + write + create + list)
    $0 -s stbanprdbrs -t blob -n client1

    # Gerar SAS com tempo customizado (2 horas)
    $0 -s stbanprdbrs -t blob -n client1 -e "2 hours"

    # Gerar SAS com permissões customizadas
    $0 -s stbanprdbrs -t blob -n client1 -p "r"
