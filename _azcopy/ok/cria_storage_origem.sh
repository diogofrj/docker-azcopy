...
# Parâmetros
RESOURCE_GROUP="RG-AZCOPY-ORIGEM"
STORAGE_ACCOUNT_NAME="saorigemhr"
LOCATION="eastus2"
SKU="Standard_LRS"
KIND="StorageV2"
FILE_SHARE_NAME="file-share-origem"
...
echo "Criando file share: $FILE_SHARE_NAME no Storage Account: $STORAGE_ACCOUNT_NAME"
